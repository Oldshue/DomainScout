...
const AGENTFORGE_MANIFEST = {
  ...
  rankingGuidance: [
    ...
    'Non-.com: .ai only for an AI-native/automation/data/model/developer use case; .io only for developer, infrastructure, crypto, data, or startup tooling fit; .co only when the exact name is strong enough to overcome leakage to .com; .org only for nonprofit/association/standards/education/community fit; weak resale extensions additionally require exact phrase plus extension fit plus credible end buyers — otherwise reject.',
