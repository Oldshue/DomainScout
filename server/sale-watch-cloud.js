...
async function readCloudLedger({env=process.env,fetchImpl=fetch,query='',offset=0,view='all',cursor='',token}={}){
  ...
  const pageQuery=new URLSearchParams({q:query,offset:String(offset),view,cursor}).toString();
